...
def get_job_directory(file_or_checkpoint: Union[str, Dict[str, Any]]) -> str:
    found = False
    print(file_or_checkpoint, "file or checkpoint")
    ...
    count = 0
    while not found:
        # print( os.path.join(os.path.join(directory, ".hydra/config.yaml")) ,"hydra")
        hydra_files = glob(
